...
enum BulletType : byte
{
	...
	BLT_ICEBEAM 	  = 57,
	BLT_ICEBEAM2 	  = 58, // dud ice beam, for when it hits walls
	BLT_DEATHBEAM 	  = 59, // clone of icebeam, but deadly to player
	BLT_DEATHBEAM2 	  = 60, // the dud version for when it hits walls
	BLT_SLIME 		  = 61,
	BLT_BIGYELLOW 	  = 62, // big yellow bullet (same as grenade, but not lobbed or explosive)
	BLT_YELWAVE 	  = 63,	// wavey thing
	...
	BLT_BLACKHOLE 	  = 67,
	BLT_LASER2 		  = 68,
    BLT_IGNITE 		  = 69,	// flamebringer shot that ignites the target hit
